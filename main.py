...
async def main_menu_admin(message: types.Message):
    if await check_admin(message.from_user):
        await admin_panel(message)

@dp.message(F.text == "🔥 Оценивать")
async def main_menu_rate(message: types.Message):
    await start_rating(message)

@dp.message(F.text == "👤 Моя анкета")
async def main_menu_profile(message: types.Message):
    await show_profile(message)

@dp.message(F.text == "🏆 Топы")
async def main_menu_tops(message: types.Message):
    await show_tops(message)

@dp.message(F.text == "💎 ВИП")
async def main_menu_vip(message: types.Message):
